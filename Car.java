...
public class Car {
  ...
  public Car( double mpg, double gas, String make, String model, String color, int year, double hp, double zts ) {
  ...
  public String bragOnYourCar() {
    ...
    String output = ""; 
    output = "Dude, I jus bought this sweet "
     + color+ " " + year + " " + make + " " + model + "! "
     + "It has " + horsepower + " horsepower, "
     + "gets " + mpg + " miles per gallons, "
     + "and has a " + gallons + " gallon gas tank! "
     + "And it goes from zero to sixty in  " + zts + " seconds! "
     + "It's the greatest car I'be ever owned!"; 
